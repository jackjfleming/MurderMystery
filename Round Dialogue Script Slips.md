# **Starlight Archives Murder Mystery — Printable Round Dialogue & Witness Slips**

This document contains all 48 printable dialogue and witness slips (16 characters × 3 rounds). Head Archivist Whitney can print these sheets, cut along the dashed guidelines, and distribute each guest's slip at the beginning of each corresponding round alongside that round's physical evidence drop.

---

# 🔍 **ROUND 1 SCRIPT SLIPS (Print & Cut)**

*Instructions for Whitney: Hand these slips to each guest at the start of Round 1 along with Evidence Packet 1 (Terminal Log, Incident Dossier, Audit Notes, Key Clearance Register).*
