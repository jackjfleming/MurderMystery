# **Starlight Archives Murder Mystery — Master Suspect Deduction & Exoneration Matrix**

This master reference guide breaks down all 16 suspects for the Starlight Archives Murder Mystery. For every player, it details how they are incriminated across the 6 Proof Pillars, their relation to the **Three Investigation Tracks**, the exact revelation vehicles, and the precise logical/forensic facts that exonerate them—proving why **Raelin (Keeper of Keys)** is the sole suspect who satisfies every pillar.
...
3. **🧪 Track C (Dermal Contact Poison on Display Lock):** Raelin (official conservator for RB-1147; applied Jar E Archival Fumigation Compound to lock handle).  
   *Confirmation:* UV blacklight reveals **D-E-R-M-A-L** on book spines; Jar E glows neon green under UV; toxicology matches palm & lock swabs to organomercury fumigation compound. Charlotte also holds CATCH certification and full Chemical Kit access (Jars A–E), but is exonerated by her verified front desk alibi and lack of Master Key #000.

---

## **🕵️ Master Suspect Matrices (All 16 Guests)**

### **1. RAELIN — Keeper of Keys (THE CULPRIT)**
...
**EXONERATION FACTOR:** Claire was logged in at the front desk during the 15-minute window and lacks physical master keys to the window or vault display case.

---

### **3. SARAH — Nocturnal Photographer**
...
**EXONERATION FACTOR:** The camera lens cap proves Sarah was taking photos outside the window sill, but witness reports confirm she never entered the gallery or touched Item RB-1147.

---

### **4. BROOKLYN — Underground Publisher**
...
**EXONERATION FACTOR:** Brooklyn carries a standard public reading pass with zero access to restricted gallery cases, and her printing ink smudges are non-toxic.

---

### **5. CHARLOTTE — Rare Book Specialist**
...
### **6. CHRISTINA — Silver-Tongued Debater**
...
**EXONERATION FACTOR:** Christina's console glitch was digital. She lacks physical master keys, gallery window access, Chemical Kit access, and CATCH certification.

---

### **7. VICTORIA — The Annotator**
...
### **8. ELLIE — Puzzle Tinker**

| Pillar Category | Incriminated? | How They Are Incriminated | Revelation Vehicle to Group |
| :--- | :--- | :--- | :--- |
| **1. Motive** | YES | Caught inspecting case lock mechanics without permission. | Character Secret / Script Lines |
| **2. Secret Knowledge** | YES | Knew display case used antique brass tumblers. | Character Backstory |
| **3. Physical Access** | **NO** | Workbench pass (#008); lacks physical master key to gallery window. | Key Clearance Register (#4) |
| **4. Mechanical Capability** | YES | Deep mechanical knowledge of brass lock tumblers and pick wires. | Character Role |
| **5. Verified Time Window** | **NO** | Accounted for at tinker workbench testing gear ciphers. | Character Script |
| **6. Physical Trace Evidence** | YES (Red Herring) | Scratched lock pick wire found near side entrance. | Incident Dossier (#2) / Ellie Dialogue Slip |

**EXONERATION FACTOR:** Ellie studies mechanical brass tumblers, not liquid chemistry or hazardous fumigation compounds, and was verified at her workbench. She has no Chemical Kit access or CATCH certification.

---

### **9. GIANNA — Amateur Sleuth**
...
**EXONERATION FACTOR:** Gianna has no master key access, no Chemical Kit access or CATCH certification, and her dropped wire is non-toxic audio equipment.

---

### **10. HOPE — Literary Prodigy**

| Pillar Category | Incriminated? | How They Are Incriminated | Revelation Vehicle to Group |
| :--- | :--- | :--- | :--- |
| **1. Motive** | YES | John found proof her award-winning novel was plagiarized line-for-line. | Character Secret / Script Lines |
| **2. Secret Knowledge** | YES | Received private letter questioning her manuscript earlier this week. | Character Backstory |
| **3. Physical Access** | **NO** | Breakroom access; lacks master key clearance to vault display case. | Key Clearance Register (#4) |
| **4. Mechanical Capability** | YES | Researched historical botanical poisons for manuscript writing. | Character Backstory / Secret |
| **5. Verified Time Window** | YES | Unaccounted for ("getting tea in breakroom") during 15-min window. | Character Script / Gianna Witness Sighting |
| **6. Physical Trace Evidence** | YES (Track B Decoy) | Poisoned tea cup found sitting on John's desk setup. | Physical Prop (#5) / Scent Tag |

**EXONERATION FACTOR:** Toxicology Report (#9) confirms the desk tea cup was 100% full and untasted (John gave up caffeinated tea weeks ago). Hope also lacks master keys to access Item RB-1147 in the gallery.

---

### **11. GEORGIA — Archivist of Secrets**
...
**EXONERATION FACTOR:** Georgia was working alongside Charlotte at the intake desk during the critical window and lacks chemical conservation skills.

---

### **12. KAITLIN — Silent Strategist**
...
**EXONERATION FACTOR:** Kaitlin carries no master keys, lacks chemical capability, and left zero physical trace evidence at the crime scene.

---

### **13. MADDIE — Conservatory Reader**
...
**EXONERATION FACTOR:** Ruthanne carries standard guest passes with zero access keys, lacks chemical capability, and left no physical trace evidence.

---

### **15. LUCY — Aesthetic Curator**

| Pillar Category | Incriminated? | How They Are Incriminated | Revelation Vehicle to Group |
| :--- | :--- | :--- | :--- |
| **1. Motive** | YES | John caught her replacing an 1890s oil painting with a $12.99 Amazon Prime print. | Character Secret / Script Lines |
| **2. Secret Knowledge** | YES | Knew replica pieces and lighting setups were placed throughout the halls. | Character Secret |
| **3. Physical Access** | **NO** | Display lighting key (#011) only; restricted case keys held exclusively by Keeper of Keys. | Key Clearance Register (#4) |
| **4. Mechanical Capability** | YES | Knowledge of paint solvents and frame sealants. | Character Role |
| **5. Verified Time Window** | **NO** | Confirmed alibi adjusting lighting in main hall with witnesses. | Character Script / Witness Reports |
| **6. Physical Trace Evidence** | **NO** | Paint solvent traces don't match the organomercury fumigation compound on the lock. | Toxicology Report (#9) |

**EXONERATION FACTOR:** Lucy has a verified lighting alibi in the main hall during the prep window, and her frame solvents do not match the lethal fumigation compound (Jar E). She has no Chemical Kit access or CATCH certification.
