# **Starlight Archives Murder Mystery — Host Information Flow & Clue Distribution Tracker**

*Confidential Facilitator Guide for Detective Jack & Archivist Whitney*

This master tracker replaces static player clue cards with an active host management tool. It outlines the exact physical evidence, player witness observations, red herrings, and deduction milestones for each round, allowing the hosts to monitor the room and drop whisper prompts when needed.

---

## 🔍 **Round 1: Motives, Access Discrepancies & The 3 Tracks**
...
* **Gianna:** Saw John having a tense hallway argument around 23:45 right before stepping into the reception hall.
...
> **💡 Host Whisper Prompt (If Round 1 energy lags):**  
> *"Take a close look at the Terminal Access Record—why is there a 15-minute gap where nobody was logged, right before the courtyard window sensor triggered?"*
...
### 🎯 Round 3 Host Milestone Checklist
- [ ] **Did players align the wooden overlay mask over John's handwritten letter?**
- [ ] **Did players shine the UV blacklight on the Chemical Kit to see Jar E glow neon green?**
- [ ] **Did players cross-reference the 6 Proof Pillars to distinguish Raelin from Charlotte?**
- [ ] **Are all Voting Ballots completed and placed in the ballot box?**

> **💡 Host Whisper Prompts (If players are stuck between Raelin and Charlotte):**  
> * *"Both Raelin and Charlotte have CATCH chemical training—so check who holds Master Key #000 and who was missing during the 15-minute prep window!"*  
> * *"Ask Claire and Georgia where Charlotte was sitting right before the party started!"*

---

## 🏆 **The 6-Pillar Solution Summary (For Host Reference)**

| Proof Pillar | The Sole Guilty Suspect: RAELIN (Keeper of Keys) |
| :--- | :--- |
| **1. Motive** | Facing public ruin and title revocation over the 1926 Arthur Vance fraud secret (37 Ferrets!). |
| **2. Secret Knowledge** | Knew John completed his audit and planned to expose her family scandal at midnight. |
| **3. Physical Access** | Held Master Key #000 capable of unlatching the courtyard window and opening Case RB-1147. |
| **4. Mechanical Capability** | CATCH-certified to handle Jar E (*Archival Fumigation & Anti-Pest Sealant*) and knew its lethal dermal toxicity. |
| **5. Verified Time Window** | Unaccounted-for 15-minute gap (23:30–23:45) right before doors opened. |
| **6. Physical Trace Evidence** | Master Key #000 discarded in courtyard hedges + Jar E glowing neon green under UV matching lock swab. |
